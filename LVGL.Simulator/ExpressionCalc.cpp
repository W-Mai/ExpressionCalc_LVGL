...
double evalNotation(const Notation& notation, Error& e) {
    ...
    for (const auto& note : notation) {
        ...
        if (checkNumber(it, note)) {
            ...
            if (note == "hello") { printf("Hi!"); resultStack.push(0); } else if (note == "PI") { resultStack.push(3.1415926537579); } else if (note == "E") { resultStack.push(2.718281828); } else if (note == "abs") resultStack.push(abs(param[0]));
